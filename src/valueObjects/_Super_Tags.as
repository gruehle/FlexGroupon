 ...
 * of this value object you may modify the generated sub-class of this class - Tags.as.
 */
...
[ExcludeClass]
public class _Super_Tags extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _TagsEntityMetadata;
     ...
     * properties
     */
    private var _internal_tag : ArrayCollection;
    model_internal var _internal_tag_leaf:valueObjects.Tag;
    ...
    public function _Super_Tags()
    {
        _model = new _TagsEntityMetadata(this);
    ...
    public function get tag() : ArrayCollection
    {
    ...
    {
        var oldValue:ArrayCollection = _internal_tag;
        if (oldValue !== value)
        {
            ...
            {
                _internal_tag = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_tag = null;
            ...
            {
                throw new Error("value of tag must be a collection");
            }
    ...
    model_internal function setterListenerTag(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerTag);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TagsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TagsEntityMetadata) : void
    {
        var oldValue : _TagsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfTag : ArrayCollection;
