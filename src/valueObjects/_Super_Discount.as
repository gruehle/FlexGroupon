 ...
 * of this value object you may modify the generated sub-class of this class - Discount.as.
 */
...
[ExcludeClass]
public class _Super_Discount extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DiscountEntityMetadata;
    ...
    public function _Super_Discount()
    {
        _model = new _DiscountEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DiscountEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DiscountEntityMetadata) : void
    {
        var oldValue : _DiscountEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
