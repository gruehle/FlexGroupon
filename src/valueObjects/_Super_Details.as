...
public class _Super_Details extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_detail : valueObjects.Detail;
    ...
    public function get detail() : valueObjects.Detail
    {
    ...
    public function set detail(value:valueObjects.Detail) : void
    {
        var oldValue:valueObjects.Detail = _internal_detail;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDetail : valueObjects.Detail;

    model_internal function _doValidationForDetail(valueIn:Object):Array
    {
        var value : valueObjects.Detail = valueIn as valueObjects.Detail;
